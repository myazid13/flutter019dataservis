...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        title: 'DATA SERVIS GEEKO KOMPUTER',
        theme: ThemeData(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(hintText: 'No Telp/WA'),
                  ),
                  const SizedBox(
                    height: 20,
                  ),
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(hintText: 'Tipe Laptop'),
                  ),
                  const SizedBox(
                    height: 20,
                  ),
                  TextField(
                    ...
                    decoration: const InputDecoration(hintText: 'Merk Laptop'),
                  ),
                  const SizedBox(
                    height: 20,
                  ),
...
// Insert a new journal to the database
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Geeko Komputer'),
      ),
      body: _isLoading
          ? const Center(
